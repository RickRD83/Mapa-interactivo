...
var format_Informaciondecalles_7 = new ol.format.GeoJSON();
var features_Informaciondecalles_7 = format_Informaciondecalles_7.readFeatures(json_Informaciondecalles_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Informaciondecalles_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Informaciondecalles_7.addFeatures(features_Informaciondecalles_7);
var lyr_Informaciondecalles_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Informaciondecalles_7, 
                style: style_Informaciondecalles_7,
                popuplayertitle: 'Informacion de calles',
                interactive: true,
    title: 'Informacion de calles<br />\
    <img src="styles/legend/Informaciondecalles_7_0.png" /> Alto<br />\
    <img src="styles/legend/Informaciondecalles_7_1.png" /> Medio<br />\
    <img src="styles/legend/Informaciondecalles_7_2.png" /> Bajo<br />' });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_GoogleSatelite_1.setVisible(false);lyr_GoogleHybrid_2.setVisible(false);lyr_Areadeestudio_3.setVisible(true);lyr_Informaciondelarea_4.setVisible(true);lyr_AreasAfectadas_5.setVisible(true);lyr_Linderosdelasareasafectadas_6.setVisible(true);lyr_Informaciondecalles_7.setVisible(true);lyr_Linderos_8.setVisible(true);lyr_ExposicionVulnerable_9.setVisible(true);lyr_Puntoscriticos_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_GoogleSatelite_1,lyr_GoogleHybrid_2,lyr_Areadeestudio_3,lyr_Informaciondelarea_4,lyr_AreasAfectadas_5,lyr_Linderosdelasareasafectadas_6,lyr_Informaciondecalles_7,lyr_Linderos_8,lyr_ExposicionVulnerable_9,lyr_Puntoscriticos_10];
...
lyr_Informaciondecalles_7.set('fieldAliases', {'id': 'id', 'dist': 'Distancia (m)', 'nombre_via': 'Nombre de la calle', 'longitud_m': 'Longitud (m)', 'ancho_m': 'Ancho (m)', 'nivel_ries': 'Nivel de Riesgo', 'estado_dre': 'Estado del drenaje', 'inund_max_': 'Altura máxima del agua (m)', 'pob_expues': 'Población expuesta', 'jerarquia_': 'Jerarquia', 'azimuth': 'Azimuth', 'Rumbo': 'Rumbo', });
lyr_Linderos_8.set('fieldAliases', {'id': 'id', 'Distance': 'Distancia (m)', 'azimuth': 'Azimuth', 'Rumbo': 'Rumbo', });
lyr_ExposicionVulnerable_9.set('fieldAliases', {'id': 'id', 'Coor_X': 'Coordenadas Este', 'Coor_Y': 'Coordenadas Norte', 'nombre': 'Nombre del lugar', 'infra_critica': 'Infraestructura crítica', 'uso_suelo': 'Uso del suelo', 'nivel_vul': 'Nivel de vulnerabilidad', });
lyr_Puntoscriticos_10.set('fieldAliases', {'id_punto': 'id_punto', 'frecuencia': 'Frecuencia', 'causa_prin': 'Causa principal', 'urgencia': 'Urgencia', 'coordenada': 'Coordenadas Este', 'coordena_1': 'Coordenadas Norte', 'costo_repa': 'Costo de reparación', 'recomendac': 'Recomendación', 'fuente': 'Fuente de datos', });
...
lyr_Informaciondecalles_7.set('fieldImages', {'id': 'TextEdit', 'dist': 'TextEdit', 'nombre_via': 'TextEdit', 'longitud_m': 'TextEdit', 'ancho_m': 'TextEdit', 'nivel_ries': 'TextEdit', 'estado_dre': 'TextEdit', 'inund_max_': 'TextEdit', 'pob_expues': 'TextEdit', 'jerarquia_': 'TextEdit', 'azimuth': 'TextEdit', 'Rumbo': 'TextEdit', });
lyr_Linderos_8.set('fieldImages', {'id': 'TextEdit', 'Distance': 'TextEdit', 'azimuth': 'TextEdit', 'Rumbo': 'TextEdit', });
lyr_ExposicionVulnerable_9.set('fieldImages', {'id': 'TextEdit', 'Coor_X': 'TextEdit', 'Coor_Y': 'TextEdit', 'nombre': 'TextEdit', 'infra_critica': 'TextEdit', 'uso_suelo': 'TextEdit', 'nivel_vul': 'TextEdit', });
lyr_Puntoscriticos_10.set('fieldImages', {'id_punto': 'TextEdit', 'frecuencia': 'TextEdit', 'causa_prin': 'TextEdit', 'urgencia': 'TextEdit', 'coordenada': 'TextEdit', 'coordena_1': 'TextEdit', 'costo_repa': 'TextEdit', 'recomendac': 'TextEdit', 'fuente': 'TextEdit', });
...
lyr_Informaciondecalles_7.set('fieldLabels', {'id': 'hidden field', 'dist': 'inline label - always visible', 'nombre_via': 'inline label - always visible', 'longitud_m': 'inline label - always visible', 'ancho_m': 'inline label - always visible', 'nivel_ries': 'inline label - always visible', 'estado_dre': 'inline label - always visible', 'inund_max_': 'inline label - always visible', 'pob_expues': 'inline label - always visible', 'jerarquia_': 'inline label - always visible', 'azimuth': 'inline label - always visible', 'Rumbo': 'inline label - always visible', });
...
lyr_ExposicionVulnerable_9.set('fieldLabels', {'id': 'hidden field', 'Coor_X': 'inline label - always visible', 'Coor_Y': 'inline label - always visible', 'nombre': 'inline label - always visible', 'infra_critica': 'inline label - always visible', 'uso_suelo': 'inline label - always visible', 'nivel_vul': 'inline label - always visible', });
lyr_Puntoscriticos_10.set('fieldLabels', {'id_punto': 'hidden field', 'frecuencia': 'inline label - always visible', 'causa_prin': 'inline label - always visible', 'urgencia': 'inline label - always visible', 'coordenada': 'inline label - always visible', 'coordena_1': 'inline label - always visible', 'costo_repa': 'inline label - always visible', 'recomendac': 'inline label - always visible', 'fuente': 'inline label - always visible', });
